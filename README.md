...
| :--- | :--- |
| **Backend & Architecture** | Java (Advanced), Spring Boot, Maven, RBAC, SOA, SDLC |
| **Cloud Infrastructure** | **4x OCI Certified (Architect & Developer)**, Automation, Networking |
| **Data & AI** | Python (LightGBM/LSTM), SQL (SQLite, PL/SQL, MySQL), REST APIs |
| **Web & Networking** | PHP, JavaScript, Cisco Networking (Routing & Switching) |
...
**[StockWise-Forecasting-App](https://github.com/BAnalysis-3-2/StockWise-Forecasting-Website)** *(In Active Development)*
* **The Interface:** A high-performance **React/Next.js** application serving as the Business Intelligence (BI) layer for the StockWise ecosystem.
...
**[Product-Sales-Java](https://github.com/vukona-dev/product-sales-java)**
* Created a retail sales management tool using **Java Swing** and **MySQL**.
* Focused on database relational mapping and CRUD integrity.
